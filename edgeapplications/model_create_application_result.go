...
type _CreateApplicationResult CreateApplicationResult
...
func (o *CreateApplicationResult) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateApplicationResult := _CreateApplicationResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateApplicationResult)

	if err != nil {
		return err
	}

	*o = CreateApplicationResult(varCreateApplicationResult)
