...
type _OriginsResponse OriginsResponse
...
func (o *OriginsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOriginsResponse := _OriginsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOriginsResponse)

	if err != nil {
		return err
	}

	*o = OriginsResponse(varOriginsResponse)
