...
// checks if the PatchDeviceGroupsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchDeviceGroupsRequest{}

// PatchDeviceGroupsRequest struct for PatchDeviceGroupsRequest
type PatchDeviceGroupsRequest struct {
...
type NullablePatchDeviceGroupsRequest struct {
	value *PatchDeviceGroupsRequest
	isSet bool
}
...
func NewNullablePatchDeviceGroupsRequest(val *PatchDeviceGroupsRequest) *NullablePatchDeviceGroupsRequest {
	return &NullablePatchDeviceGroupsRequest{value: val, isSet: true}
}
