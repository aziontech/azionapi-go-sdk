...
func NewCreateRulesEngineRequestBehaviors(name string) *CreateRulesEngineRequestBehaviors {
	this := CreateRulesEngineRequestBehaviors{}
	this.Name = name
	return &this
}
...
type NullableCreateRulesEngineRequestBehaviors struct {
	value *CreateRulesEngineRequestBehaviors
	isSet bool
}

func (v NullableCreateRulesEngineRequestBehaviors) Get() *CreateRulesEngineRequestBehaviors {
	return v.value
}

func (v *NullableCreateRulesEngineRequestBehaviors) Set(val *CreateRulesEngineRequestBehaviors) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRulesEngineRequestBehaviors) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRulesEngineRequestBehaviors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRulesEngineRequestBehaviors(val *CreateRulesEngineRequestBehaviors) *NullableCreateRulesEngineRequestBehaviors {
	return &NullableCreateRulesEngineRequestBehaviors{value: val, isSet: true}
}

func (v NullableCreateRulesEngineRequestBehaviors) MarshalJSON() ([]byte, error) {
