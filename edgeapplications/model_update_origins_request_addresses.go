...
func NewUpdateOriginsRequestAddresses(address string) *UpdateOriginsRequestAddresses {
	this := UpdateOriginsRequestAddresses{}
...
type NullableUpdateOriginsRequestAddresses struct {
	value *UpdateOriginsRequestAddresses
	isSet bool
}

func (v NullableUpdateOriginsRequestAddresses) Get() *UpdateOriginsRequestAddresses {
	return v.value
}

func (v *NullableUpdateOriginsRequestAddresses) Set(val *UpdateOriginsRequestAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOriginsRequestAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOriginsRequestAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOriginsRequestAddresses(val *UpdateOriginsRequestAddresses) *NullableUpdateOriginsRequestAddresses {
	return &NullableUpdateOriginsRequestAddresses{value: val, isSet: true}
}
