...
// checks if the OriginsResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OriginsResponseLinks{}
...
func NewNullableOriginsResponseLinks(val *OriginsResponseLinks) *NullableOriginsResponseLinks {
	return &NullableOriginsResponseLinks{value: val, isSet: true}
}
