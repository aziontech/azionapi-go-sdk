...
func NewUpdateRulesEngineRequestBehaviors(name string) *UpdateRulesEngineRequestBehaviors {
	this := UpdateRulesEngineRequestBehaviors{}
	this.Name = name
	return &this
}
...
type NullableUpdateRulesEngineRequestBehaviors struct {
	value *UpdateRulesEngineRequestBehaviors
	isSet bool
}

func (v NullableUpdateRulesEngineRequestBehaviors) Get() *UpdateRulesEngineRequestBehaviors {
	return v.value
}

func (v *NullableUpdateRulesEngineRequestBehaviors) Set(val *UpdateRulesEngineRequestBehaviors) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRulesEngineRequestBehaviors) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRulesEngineRequestBehaviors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRulesEngineRequestBehaviors(val *UpdateRulesEngineRequestBehaviors) *NullableUpdateRulesEngineRequestBehaviors {
	return &NullableUpdateRulesEngineRequestBehaviors{value: val, isSet: true}
}

func (v NullableUpdateRulesEngineRequestBehaviors) MarshalJSON() ([]byte, error) {
