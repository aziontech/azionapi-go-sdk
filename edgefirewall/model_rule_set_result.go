...
// checks if the RuleSetResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleSetResult{}
...
func NewNullableRuleSetResult(val *RuleSetResult) *NullableRuleSetResult {
	return &NullableRuleSetResult{value: val, isSet: true}
}
