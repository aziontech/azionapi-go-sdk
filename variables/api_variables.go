...
*/
func (a *VariablesApiService) ApiSchemaRetrieve(ctx context.Context) ApiApiSchemaRetrieveRequest {
	return ApiApiSchemaRetrieveRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *VariablesApiService) ApiSchemaRetrieveExecute(r ApiApiSchemaRetrieveRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VariablesApiService.ApiSchemaRetrieve")
	if err != nil {
