...
// checks if the PaginatedS3CredentialList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedS3CredentialList{}

// PaginatedS3CredentialList struct for PaginatedS3CredentialList
type PaginatedS3CredentialList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []S3Credential `json:"results,omitempty"`
}
...
func NewPaginatedS3CredentialList() *PaginatedS3CredentialList {
	this := PaginatedS3CredentialList{}
	return &this
}
...
func (o *PaginatedS3CredentialList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedS3CredentialList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []S3Credential and assigns it to the Results field.
func (o *PaginatedS3CredentialList) SetResults(v []S3Credential) {
	o.Results = v
}

func (o PaginatedS3CredentialList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedS3CredentialList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedS3CredentialList struct {
	value *PaginatedS3CredentialList
	isSet bool
}

func (v NullablePaginatedS3CredentialList) Get() *PaginatedS3CredentialList {
	return v.value
}

func (v *NullablePaginatedS3CredentialList) Set(val *PaginatedS3CredentialList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedS3CredentialList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedS3CredentialList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedS3CredentialList(val *PaginatedS3CredentialList) *NullablePaginatedS3CredentialList {
	return &NullablePaginatedS3CredentialList{value: val, isSet: true}
}

func (v NullablePaginatedS3CredentialList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedS3CredentialList) UnmarshalJSON(src []byte) error {
	v.isSet = true
