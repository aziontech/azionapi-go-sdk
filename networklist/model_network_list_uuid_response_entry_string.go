...
// checks if the NetworkListUuidResponseEntryString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkListUuidResponseEntryString{}
...
func NewNetworkListUuidResponseEntryString() *NetworkListUuidResponseEntryString {
	this := NetworkListUuidResponseEntryString{}
	return &this
}
...
type NullableNetworkListUuidResponseEntryString struct {
	value *NetworkListUuidResponseEntryString
	isSet bool
}
...
func NewNullableNetworkListUuidResponseEntryString(val *NetworkListUuidResponseEntryString) *NullableNetworkListUuidResponseEntryString {
	return &NullableNetworkListUuidResponseEntryString{value: val, isSet: true}
}
