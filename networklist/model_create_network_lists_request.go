...
// checks if the CreateNetworkListsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkListsRequest{}
...
func NewCreateNetworkListsRequest() *CreateNetworkListsRequest {
	this := CreateNetworkListsRequest{}
	return &this
}
...
type NullableCreateNetworkListsRequest struct {
	value *CreateNetworkListsRequest
	isSet bool
}
...
func NewNullableCreateNetworkListsRequest(val *CreateNetworkListsRequest) *NullableCreateNetworkListsRequest {
	return &NullableCreateNetworkListsRequest{value: val, isSet: true}
}
