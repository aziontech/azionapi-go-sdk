...
// checks if the DomainDataResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainDataResponse{}

// DomainDataResponse struct for DomainDataResponse
type DomainDataResponse struct {
	...
	DigitalCertificateId *int64 `json:"digital_certificate_id,omitempty"`
...
// SetDigitalCertificateId gets a reference to the given int64 and assigns it to the DigitalCertificateId field.
...
func (o *DomainDataResponse) SetMtlsTrustedCaCertificateIdNil() {
...
func (o *DomainDataResponse) SetEdgeFirewallIdNil() {
...
func (o DomainDataResponse) MarshalJSON() ([]byte, error) {
...
func (o DomainDataResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDomainDataResponse struct {
	value *DomainDataResponse
	isSet bool
}

func (v NullableDomainDataResponse) Get() *DomainDataResponse {
	return v.value
}

func (v *NullableDomainDataResponse) Set(val *DomainDataResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainDataResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainDataResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainDataResponse(val *DomainDataResponse) *NullableDomainDataResponse {
	return &NullableDomainDataResponse{value: val, isSet: true}
}

func (v NullableDomainDataResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainDataResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
