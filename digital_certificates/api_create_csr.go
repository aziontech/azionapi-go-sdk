...
func (r ApiCreateCSRRequest) CreateCSRRequest(createCSRRequest CreateCSRRequest) ApiCreateCSRRequest {
	r.createCSRRequest = &createCSRRequest
	return r
}
...
*/
func (a *CreateCSRApiService) CreateCSR(ctx context.Context) ApiCreateCSRRequest {
	return ApiCreateCSRRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CreateCSRApiService) CreateCSRExecute(r ApiCreateCSRRequest) (*DC201, *http.Response, error) {
	...
	if r.createCSRRequest == nil {
		return localVarReturnValue, nil, reportError("createCSRRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createCSRRequest
	if r.ctx != nil {
