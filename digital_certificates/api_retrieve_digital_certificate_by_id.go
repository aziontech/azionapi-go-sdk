...
//  @return DC200
func (a *RetrieveDigitalCertificateByIDApiService) GetCertificateExecute(r ApiGetCertificateRequest) (*DC200, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RetrieveDigitalCertificateByIDApiService.GetCertificate")
	if err != nil {
